...
function noBoxCSS() {
    document.getElementById('box-css').style.animationName = "css-inverse"
}
...
function noBoxJS() {
    document.getElementById('box-js').style.animationName = "js-inverse"
}
...
function noBoxBoot() {
    document.getElementById('box-boot').style.animationName = "boot-inverse"
}